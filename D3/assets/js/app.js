...
x_t = (wide - labelArea) / 2 + labelArea;
y_t= height - margin - downSpace;
xText.attr("transform","translate(" + x_t +", " + y_t +")" );
...
yText.attr("transform","translate(" +((height - labelArea) / 2 + labelArea) +", " + (wide - margin - leftSpace) +")");
